...
namespace AssemblerLib.Grammar_Rules.Substitution
{
    ...
    {
        private Regex movMatch = new Regex("^MOV([A-Z]{2})?$");
        private DataProccessRegisterBuilder builder = new DataProccessRegisterBuilder();

        // MOV R0, R14, 0

        private RegisterToken discard = new RegisterToken("R0");
